...
MySQL - 10.1.21-MariaDB : Database - yzjvincb_mydragon
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`yzjvincb_mydragon` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `yzjvincb_mydragon`;
...
(11,10,4,'Nagabonar','2017-05-24',0,0,100,100),
(12,11,1,'nfewenfk','2017-05-24',0,0,100,100),
(13,12,9,NULL,'2017-05-24',0,0,100,100),
(14,13,3,'iniitutes','2017-05-24',0,0,100,100);
...
(2,2,'images/CaniDragon/2.gif','images/CaniDragon/i2.gif'),
(3,3,'images/CaniDragon/3.gif','images/CaniDragon/i3.gif'),
(4,4,'images/CaniDragon/4.gif','images/CaniDragon/i4.gif'),
(5,5,'images/CaniDragon/5.gif','images/CaniDragon/i5.gif'),
(6,6,'images/CaniDragon/6.gif','images/CaniDragon/i6.gif'),
(7,1,'images/DarkDragon/1.gif','images/DarkDragon/i1.gif'),
(8,2,'images/DarkDragon/2.gif','images/DarkDragon/i2.gif'),
(9,3,'images/DarkDragon/3.gif','images/DarkDragon/i3.gif'),
(10,4,'images/DarkDragon/4.gif','images/DarkDragon/i4.gif'),
(11,5,'images/DarkDragon/5.gif','images/DarkDragon/i5.gif'),
(12,6,'images/DarkDragon/6.gif','images/DarkDragon/i6.gif'),
(13,1,'images/Dino/1.gif','images/Dino/i1.gif'),
(14,2,'images/Dino/2.gif','images/Dino/i2.gif'),
(15,3,'images/Dino/3.gif','images/Dino/i3.gif'),
(16,4,'images/Dino/4.gif','images/Dino/i4.gif'),
(17,5,'images/Dino/5.gif','images/Dino/i5.gif'),
(18,6,'images/Dino/6.gif','images/Dino/i6.gif'),
(19,1,'images/EasternDragon/1.gif','images/EasternDragon/i1.gif'),
(20,2,'images/EasternDragon/2.gif','images/EasternDragon/i2.gif'),
(21,3,'images/EasternDragon/3.gif','images/EasternDragon/i3.gif'),
(22,4,'images/EasternDragon/4.gif','images/EasternDragon/i4.gif'),
(23,5,'images/EasternDragon/5.gif','images/EasternDragon/i5.gif'),
(24,6,'images/EasternDragon/6.gif','images/EasternDragon/i6.gif'),
(25,1,'images/FeliDragon/1.gif','images/FeliDragon/i1.gif'),
(26,2,'images/FeliDragon/2.gif','images/FeliDragon/i2.gif'),
(27,3,'images/FeliDragon/3.gif','images/FeliDragon/i3.gif'),
(28,4,'images/FeliDragon/4.gif','images/FeliDragon/i4.gif'),
(29,5,'images/FeliDragon/5.gif','images/FeliDragon/i5.gif'),
(30,6,'images/FeliDragon/6.gif','images/FeliDragon/i6.gif'),
(31,1,'images/FurdDragon/1.gif','images/FurdDragon/i1.gif'),
(32,2,'images/FurdDragon/2.gif','images/FurdDragon/i2.gif'),
(33,3,'images/FurdDragon/3.gif','images/FurdDragon/i3.gif'),
(34,4,'images/FurdDragon/4.gif','images/FurdDragon/i4.gif'),
(35,5,'images/FurdDragon/5.gif','images/FurdDragon/i5.gif'),
(36,6,'images/FurdDragon/6.gif','images/FurdDragon/i6.gif'),
(37,1,'images/Lizardus/1.gif','images/Lizardus/i1.gif'),
(38,2,'images/Lizardus/2.gif','images/Lizardus/i2.gif'),
(39,3,'images/Lizardus/3.gif','images/Lizardus/i3.gif'),
(40,4,'images/Lizardus/4.gif','images/Lizardus/i4.gif'),
(41,5,'images/Lizardus/5.gif','images/Lizardus/i5.gif'),
(42,6,'images/Lizardus/6.gif','images/Lizardus/i6.gif'),
(43,1,'images/PlesioDragon/1.gif','images/PlesioDragon/i1.gif'),
(44,2,'images/PlesioDragon/2.gif','images/PlesioDragon/i2.gif'),
(45,3,'images/PlesioDragon/3.gif','images/PlesioDragon/i3.gif'),
(46,4,'images/PlesioDragon/4.gif','images/PlesioDragon/i4.gif'),
(47,5,'images/PlesioDragon/5.gif','images/PlesioDragon/i5.gif'),
(48,6,'images/PlesioDragon/6.gif','images/PlesioDragon/i6.gif'),
(49,1,'images/PteroDragon/1.gif','images/PteroDragon/i1.gif'),
(50,2,'images/PteroDragon/2.gif','images/PteroDragon/i2.gif'),
(51,3,'images/PteroDragon/3.gif','images/PteroDragon/i3.gif'),
(52,4,'images/PteroDragon/4.gif','images/PteroDragon/i4.gif'),
(53,5,'images/PteroDragon/5.gif','images/PteroDragon/i5.gif'),
(54,6,'images/PteroDragon/6.gif','images/PteroDragon/i6.gif'),
(55,1,'images/WesternDragon/1.gif','images/WesternDragon/i1.gif'),
(56,2,'images/WesternDragon/2.gif','images/WesternDragon/i2.gif'),
(57,3,'images/WesternDragon/3.gif','images/WesternDragon/i3.gif'),
(58,4,'images/WesternDragon/4.gif','images/WesternDragon/i4.gif'),
(59,5,'images/WesternDragon/5.gif','images/WesternDragon/i5.gif'),
(60,6,'images/WesternDragon/6.gif','images/WesternDragon/i6.gif'),
(61,1,'images/Wyvern/1.gif','images/Wyvern/i1.gif'),
(62,2,'images/Wyvern/2.gif','images/Wyvern/i2.gif'),
(63,3,'images/Wyvern/3.gif','images/Wyvern/i3.gif'),
(64,4,'images/Wyvern/4.gif','images/Wyvern/i4.gif'),
(65,5,'images/Wyvern/5.gif','images/Wyvern/i5.gif'),
(66,6,'images/Wyvern/6.gif','images/Wyvern/i6.gif');
...
insert  into `stage_naga`(`spesies_ID`,`stage_ID`) values 
(11,1),
(11,2),
(11,3),
(11,4),
...
(10,'iGung','i@gu.ng','7ac018ba7372bada047112e0c192e25b',NULL,'2017-05-24 01:49:17',NULL),
(11,'naga','naga@na.ga','0a82e736d22f6156c4c9e9118e8953c3',NULL,'2017-05-24 01:51:42',NULL),
(12,'ababa','aba@aba.aba','88cbc990f555585c848f265d56bbb85a',NULL,'2017-05-24 01:53:38',NULL),
(13,'inites','ini@tes.c','e66fba2389bc42be682dbf7aa1232709',NULL,'2017-05-24 01:54:21',NULL);
...
/* Function  structure for function  `fn_random` */

/*!50003 DROP FUNCTION IF EXISTS `fn_random` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_random`(
		pmin INTEGER,
		pmax INTEGER ) RETURNS int(11)
BEGIN
		SET @random = FLOOR(pmin + RAND()*( pmax-pmin));
	RETURN @random;
    END */$$
DELIMITER ;

/* Function  structure for function  `fn_stage` */

/*!50003 DROP FUNCTION IF EXISTS `fn_stage` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_stage`(
	p_level int) RETURNS smallint(6)
BEGIN
		    if (p_level=0) THEN return 1;
		    ELSEIF(p_level>=1 AND p_level<=5)then RETURN 2;
		    ELSEIF(p_level>=6 AND p_level<=10) then RETURN 3;
		    ELSEIF(p_level>=11 AND p_level<=15) then RETURN 4;
		    ELSEIF(p_level>=16 AND p_level<=20) Then RETURN 5;
		    ELSEIF(p_level>=21)THEN RETURN 6;  
		    end IF;
	    END */$$
DELIMITER ;
...
BEGIN
	IF EXISTS (SELECT 1 FROM usr_account WHERE `usr_account`.`usr_nama`=p_username) THEN 
	SELECT
	    `naga_player`.`naga_ID`
	    , `naga_player`.`usr_ID`
	    , `naga_player`.`spesies_ID`
	    , `naga_player`.`naga_nama`
	    , `naga_player`.`naga_tgl_lahir`
	    , `naga_player`.`naga_level`
	    , `naga_player`.`XP`
	    , `naga_player`.`lapar`
	    , `naga_player`.`senang`
	    , `naga`.`spesies_nama`
	    ...
	    , `stage`.`icon`
	FROM
	    `yzjvincb_mydragon`.`naga_player`
	    INNER JOIN `yzjvincb_mydragon`.`usr_account` 
		ON (`naga_player`.`usr_ID` = `usr_account`.`usr_ID`)
	    INNER JOIN `yzjvincb_mydragon`.`naga` 
		ON (`naga_player`.`spesies_ID` = `naga`.`spesies_ID`)
	    INNER JOIN `yzjvincb_mydragon`.`stage_naga` 
		ON (`stage_naga`.`spesies_ID` = `naga`.`spesies_ID`)
	    INNER JOIN `yzjvincb_mydragon`.`stage` 
		ON (`stage_naga`.`stage_ID` = `stage`.`stage_ID`)
		WHERE `usr_account`.`usr_nama`=p_username 
		and `stage`.`stage`= (SELECT fn_stage(`naga_player`.`naga_level`));
